...
BigNumber::BigNumber(const BigNumber& other_)
{
   ...
   //óáðàòü îøèáêó Ñ6386 Ïåðåïîëíåíèå áóôåðà ïðè çàïèñè â "number".
...
BigNumber BigNumber::operator+(BigNumber& other_) 
{
   ...
   //Âûáèðàåì ãäå áîëüøå ìåñòà + 1, ÷òîáû íå òðîãàòü Expansion 
   //Ìîæíî áûëî ðåàëèçîâàòü è ñ *max_number, íî òîãäà íóæíî áûëî áû äåëàòü ðàñøèðåíèå, à ýòî ìåíåå ýôôåêòèâíî
   ...
   //Ñìîòðèì ÷òî áîëüøå è äîïîëíÿåì äî íåãî
...
{
   for (size_t i = 0; i < size_; i++)//Èòåðàòîð
   {
...
ostream& operator<<(ostream& stream, const BigNumber& object_)
{
   if (object_.size > 0)
   {
      ...
      // Îòäåëüíî, ò.ê. åñëè i >= 0, òî òèï size_t áóäåò çàìåíÿòü îòðèöàòåëüíûå ÷èñëà íà 0 
      // è ïîëó÷èòñÿ, ÷òî 0 - 1 = 0 -> ïðîäîëæàåì öèêë
      stream << object_[0];
   }
